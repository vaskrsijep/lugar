...
const Hero = () => {
  return (
    <>
      <Navbar />
      <div className="relative bg-white pb-[110px] pt-[120px] dark:bg-dark lg:pt-[150px] flex items-center justify-center">
              ...
              <div className="hero-content">
                ...
                <ul className="flex flex-wrap items-center">
                  <li>
                    <a
                      href="/#"
                      className="inline-flex items-center justify-center rounded-md bg-blue-800 px-6 py-3 text-center text-base font-medium text-white hover:bg-blue-700 lg:px-7"
                    >
                      Get Started
                    </a>
                  </li>
...
const Navbar = () => {
  ...
  return (
    <header className={`absolute left-0 top-0 z-20 flex w-full items-center justify-center`}>
      <div className="container">
        <div className="relative -mx-4 flex items-center justify-between">
          ...
          <div className="flex w-full items-center justify-between px-4">
            ...
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              ...
              <a
                href="/#"
                className="rounded-lg bg-blue-800 px-7 py-3 text-base font-medium text-white hover:bg-opacity-90"
              >
                Sign Up
              </a>
            </div>
